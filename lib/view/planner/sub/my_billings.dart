...
class ViewPlannerBilling extends StatefulWidget {
  const ViewPlannerBilling({Key? key}) : super(key: key);

  @override
  State<ViewPlannerBilling> createState() => _ViewPlannerBillingState();
}

class _ViewPlannerBillingState extends State<ViewPlannerBilling> {
  ...
  Future refresh() async {
    setState(() {
      _billings = _billingCtrl.getPlannerBilling(
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              itemBuilder: (context, int index) {
                ...
                final title =
                    "You received P$amount from ${snapshot.data[index]["header"]["customer"]["name"]["first"]}";
                final cardNumber =
